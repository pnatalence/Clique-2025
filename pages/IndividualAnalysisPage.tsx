...
const IndividualAnalysisPage: React.FC<IndividualAnalysisPageProps> = ({ setCurrentPage }) => {
  return (
    <div className="flex flex-col h-full space-y-4">
        <header className="relative flex justify-end items-center pb-4 border-b-2 border-gray-200 dark:border-gray-700">
            <h1 className="absolute left-1/2 -translate-x-1/2 text-2xl font-bold text-gray-500 dark:text-gray-400 tracking-widest uppercase">Análise Individual</h1>
        ...
        <div className="relative bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-md">
            <button className="absolute top-6 right-6 p-2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition-colors" aria-label="Pesquisar produto">
